...
from .mixed_dataset import Audio2MotionDatasetToken, MixedDatasetCB, Audio2MotionDatasetEval
from .utils import beat2_emage_collate


class Beat2LibriSpeechDataModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        data_root_librispeech = cfg.DATASET.LIBRISPEECH.ROOT

        self.hparams.smpl_path =cfg.DATASET.smpl_path
        self.hparams.args = cfg.DATASET

        self.hparams.data_root_beat2 = data_root_beat2
        self.hparams.data_root_librispeech = data_root_librispeech
        self.hparams.token_root_librispeech = cfg.DATASET.LIBRISPEECH.TOKEN_ROOT
        ...
        if cfg.TRAIN.STAGE == "vae":
            ...
            self.Dataset = Audio2MotionDatasetToken
            self.DatasetEval = Audio2MotionDatasetToken
        else:
            raise RuntimeError("Haven't setup this code!")
