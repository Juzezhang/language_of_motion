...
from .mixed_dataset import MixedDatasetToken, MixedDatasetCB, Audio2MotionDatasetEval, Motion2EmotionDatasetEval
from .utils import beat2_emage_collate


class MixedDataModuleM2E(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        self.DatasetEval = Motion2EmotionDatasetEval
