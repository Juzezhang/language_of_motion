...
from .humanml import Text2MotionDatasetEval, Text2MotionDataset, Text2MotionDatasetCB, MotionDataset, MotionDatasetVQ, \
    Text2MotionDatasetToken, Text2MotionDatasetM2T, Audio2MotionDatasetCB, Audio2MotionDatasetEval, AudioText2MotionDatasetCB
from .utils import beat2_collate


class Beat2AmassDataModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):

        super().__init__(collate_fn=beat2_collate)
        self.cfg = cfg
        ...
        # Path to the dataset
        data_root = cfg.DATASET.BEAT2_AMASS.ROOT

        self.hparams.data_root = data_root
        self.hparams.text_dir = pjoin(data_root, "texts")
        self.hparams.audio_dir = pjoin(data_root, "beat2_audio_segmented")
        ...
        # self.hparams.max_text_len = cfg.DATASET.BEAT2.MAX_TEXT_LEN
        ...
        if cfg.TRAIN.STAGE == "vae":
            ...
            self.hparams.std_text = cfg.DATASET.BEAT2.STD_TEXT
            self.Dataset = AudioText2MotionDatasetCB
