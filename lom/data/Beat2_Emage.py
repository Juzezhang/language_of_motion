...
from .beat2 import Audio2MotionDatasetToken, Audio2MotionDatasetCB, Audio2MotionDatasetEval
from .utils import beat2_emage_collate


class Beat2DataModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        if cfg.TRAIN.STAGE == "vae":
            ...
            self.Dataset = Audio2MotionDatasetCB
