...
from .mixed_dataset import MixedDatasetToken, MixedDatasetVQ
...
class MixedDataModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        self.hparams.dataset_configs = cfg.DATASET
        ...
        # self.hparams.h3d_mean = np.load(pjoin(dis_data_root, "mean.npy"))
        # self.hparams.h3d_std = np.load(pjoin(dis_data_root, "std.npy"))
        # self.hparams.h3d_mean = np.load(pjoin(cfg.DATASET.HUMANML3D.ROOT, "Mean.npy"))
        # self.hparams.h3d_std = np.load(pjoin(cfg.DATASET.HUMANML3D.ROOT, "Std.npy"))
        ...
        # if 'datasets_test' in cfg.DATASET:
        #     dataset_configs
