    ...
    for root, dirs, files in os.walk(token_root):
        ...
        for file in files:
            if file.endswith('.npy'):
                ...
                token_dict[speaker_id][chapter_id][file_id][part_id] = np.load(token_file_path)
                count +=1
...
def main():
    ...
    output_path = '/nas/nas_32/AI-being/zhangjz/exp_motion/datasets/LibriSpeech/Quantized_LibriSpeech_Hubert_Split/train-other-500.pkl'
